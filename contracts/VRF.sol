...
contract VRF {
    ...
    function ecmulVerify(
        ...
        address expected =
            address(uint256(keccak256(abi.encodePacked(product))));
  ...
  */
    ...
    function verifyLinearCombinationWithGenerator(
        ...
        bytes32 pseudoHash =
            bytes32(GROUP_ORDER - mulmod(p[0], s, GROUP_ORDER)); // -s*p[0]
        ...
        address computed =
            ecrecover(pseudoHash, v, bytes32(p[0]), pseudoSignature);
