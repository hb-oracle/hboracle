...
/**
 * @notice A HashBridgeOracle VRF consumer which uses randomness to mimic the rolling
 * of a 20 sided die
...
contract VRFD20 is VRFConsumerBase, Owned {
     ...
     *
     * @dev NETWORK: KOVAN
     * @dev   HashBridgeOracle VRF Coordinator address: 0xdD3782915140c8f3b190B5D67eAc6dc5760C46E9
     * @dev   HBO token address:                0xa36085F69e2889c224210F603D836748e7dC0088
     * @dev   Key Hash:   0x6c3699283bda56ad74f6b855546325b68d482e983852a7a82979cc4807b641f4
     * @dev   Fee:        0.1 HBO (100000000000000000)
     *
     * @param vrfCoordinator address of the VRF Coordinator
     * @param hbo address of the HBO token
    ...
    constructor(
        ...
        bytes32 keyHash,
        uint256 fee
    ) public VRFConsumerBase(vrfCoordinator, hbo) {
        s_keyHash = keyHash;
        s_fee = fee;
    }
    ...
    {
        require(
            HBO.balanceOf(address(this)) >= s_fee,
            "Not enough HBO to pay fee"
        );
    ...
    /**
     * @notice Withdraw HBO from this contract.
     ...
     * @param to the address to withdraw HBO to
     * @param value the amount of HBO to withdraw
     */
    function withdrawHBO(address to, uint256 value) public onlyOwner {
        require(HBO.transfer(to, value), "Not enough HBO");
    }
